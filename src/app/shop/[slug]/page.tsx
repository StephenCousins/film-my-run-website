...
const products: Record<string, Product> = {
  'running-cap': {
    ...
    slug: 'running-cap',
    price: 24.99,
    images: ['https://images.filmmyrun.co.uk/shop/cap.svg', 'https://images.filmmyrun.co.uk/shop/cap.svg', 'https://images.filmmyrun.co.uk/shop/cap.svg'],
  ...
  'ultra-vest': {
    ...
    price: 89.99,
    comparePrice: 109.99,
    images: ['https://images.filmmyrun.co.uk/shop/vest.svg', 'https://images.filmmyrun.co.uk/shop/vest.svg'],
    category: 'Gear',
    rating: 4.8,
    reviews: 32,
    badge: 'Sale',
