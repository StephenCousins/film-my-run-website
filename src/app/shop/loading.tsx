export default function ShopLoading() {
  return (
    <div className="min-h-screen bg-zinc-950">
      {/* Header placeholder */}
      <div className="h-16 lg:h-20 bg-zinc-900" />

      {/* Hero skeleton */}
      <div className="py-12 lg:py-16 bg-zinc-900 border-b border-zinc-800">
        <div className="container">
          <div className="max-w-2xl">
            <div className="h-12 w-32 bg-zinc-200 dark:bg-zinc-800 rounded-lg animate-pulse mb-4" />
            <div className="h-6 w-80 bg-zinc-900 rounded animate-pulse" />
          </div>
        </div>
      </div>

      {/* Filters skeleton */}
      <div className="py-4 bg-zinc-900 border-b border-zinc-800">
        <div className="container">
