              ...
              {tools.map((tool) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Content */}
                    <h3 className="font-display text-xl font-bold text-foreground mb-2 group-hover:text-orange-500 transition-colors">
                      {tool.name}
                    </h3>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted">{tool.stats}</span>
              ...
              {calculatorTools.map((tool) => {
                ...
                return (
                  <Link
                    key={tool.name}
                    href={tool.href}
                    className="group p-4 bg-surface-tertiary rounded-xl hover:bg-orange-500/10 transition-colors"
                  >
                    <Icon className="w-6 h-6 text-orange-500 mb-2" />
                    <div className="font-medium text-foreground group-hover:text-orange-500 transition-colors text-sm">
                      {tool.name}
                    </div>
