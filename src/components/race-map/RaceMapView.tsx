  ...
  return (
    ...
    >
      ...
      {selectedRace && (
        <button
          onClick={resetZoom}
          className="absolute top-3 right-3 px-4 py-2 bg-zinc-800 border-2 border-green-500 rounded-lg text-green-500 font-semibold text-sm hover:bg-green-500 hover:text-zinc-900 transition-colors z-10"
        >
          🗺️ View All Routes
        </button>
      )}
